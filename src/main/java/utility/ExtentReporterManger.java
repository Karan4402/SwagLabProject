...
public class ExtentReporterManger extends TestBase 
{
   ...
   public static ExtentReports getReportInstance()
   {
	   if(report==null)
	   {
		   ...
		   ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Users\\dell\\Desktop\\java_Practice\\Selenium_28_Batch\\ExtentReport\\report.html");
